...
EOT
  ...
  type = map(object({
    ...
    live_trace_connectivity_logs_enabled = optional(bool)   # Default: true
    live_trace_enabled                   = optional(bool)   # Default: true
    live_trace_http_request_logs_enabled = optional(bool)   # Default: true
    live_trace_messaging_logs_enabled    = optional(bool)   # Default: true
